...
// One shared paint server: every instance is the same 20x20 gradient, so scoping
// ids per instance with useId() would only turn these icons into client components.
...
export default function InstagramIcon(props: React.SVGProps<SVGSVGElement>) {
  return (
    <svg viewBox="0 0 20 20" fill={`url(#${gradientId})`} {...props}>
